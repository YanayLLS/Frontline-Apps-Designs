...
const projectData: Record<string, { name: string; items: KBItem[] }> = {
  '915-i-series': {
    ...
    items: [
      ...
      { id: 'p1', name: 'Routine Maintenance for High-Volume Printing Equipment', type: 'procedure', steps: 35, lastUpdated: '4 hours ago', version: '1.5', image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=200&h=150&fit=crop' },
      { id: 'p2', name: 'Engine Calibration Procedure', type: 'procedure', steps: 22, lastUpdated: '1 day ago', version: '2.1', image: 'https://images.unsplash.com/photo-1565043666747-69f6646db940?w=200&h=150&fit=crop' },
      { id: 'p3', name: 'Belt Replacement Guide', type: 'procedure', steps: 15, lastUpdated: '3 days ago', version: '1.0' },
