                    ...
                    <div className="content-stretch flex items-center relative shrink-0" style={{ gap: 'var(--spacing-sm)', padding: 'var(--spacing-xs)' }}>
                      ...
                      <div className="relative" ref={moreMenuRef}>
                        <button
                          ...
                          title="More options"
                        >
                          <MoreVertical className="size-3 sm:size-4 text-white/70 hover:text-white transition-colors" />
                        </button>

                        {showMoreMenu && (
                          <div
                            className="absolute right-0 bottom-full mb-2 w-56 rounded-lg overflow-hidden z-50"
                            style={{
                          ...
                          >
                            <div className="py-1">
                              <button
                                onClick={() => { setShowMoreMenu(false); setShowHotkeys(true); }}
                              ...
                              <button
                                onClick={() => { setCameraAnimationEnabled(!cameraAnimationEnabled); setShowMoreMenu(false); }}
                                className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/90 hover:bg-white/10 transition-colors cursor-pointer"
                                style={{ fontFamily: 'var(--font-family)' }}
                              >
                                <Video className="size-4 text-white/60" />
                                {cameraAnimationEnabled ? 'Disable' : 'Enable'} camera animation
                              </button>
                              <div className="h-px bg-white/10 mx-2 my-1" />
                              <button
                                onClick={() => { onRestart(); setShowMoreMenu(false); }}
                                className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/90 hover:bg-white/10 transition-colors cursor-pointer"
                                style={{ fontFamily: 'var(--font-family)' }}
                              >
                              ...
                              <button
                                onClick={() => { onOpenFlowEditor(); setShowMoreMenu(false); }}
                                className="w-full flex items-center gap-3 px-3 py-2 text-sm text-white/90 hover:bg-white/10 transition-colors cursor-pointer"
                                style={{ fontFamily: 'var(--font-family)' }}
                              >
                      ...
                      <button
                        onClick={onBack}
                        className="relative rounded-[3px] shrink-0 size-[20px] sm:size-[24px] cursor-pointer hover:bg-white/10 flex items-center justify-center group"
                        title="Close procedure"
                      >
                        <X className="size-3 sm:size-4 text-white/70 group-hover:text-white transition-colors" />
                      </button>
                    </div>
                  </div>
