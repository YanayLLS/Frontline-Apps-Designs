        ...
        <div className="max-w-4xl space-y-6">
          ...
          <div className="bg-card border border-border rounded-[var(--radius)] p-6" style={{ boxShadow: 'var(--elevation-sm)' }}>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-[var(--radius)] bg-primary/10 flex items-center justify-center">
              ...
              <button className="px-4 py-2 bg-secondary text-foreground rounded-[var(--radius)] hover:bg-secondary/80 transition-colors" style={{
