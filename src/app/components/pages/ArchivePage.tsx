export function ArchivePage() {
  ...
  return (
    <div className="p-4">
      ...
      <div className="bg-background rounded-[var(--radius)] border border-border overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-[1fr_150px_150px_120px] gap-3 px-4 py-2.5 border-b border-border bg-card">
        ...
        {archivedItems.map((item) => (
          <div
            key={item.id}
            className="grid grid-cols-[1fr_150px_150px_120px] gap-3 px-4 py-2.5 border-b border-border last:border-b-0 hover:bg-secondary/10 transition-colors"
          >
            ...
            <div className="text-xs">
              <button className="text-primary hover:underline">Restore</button>
            </div>
          </div>
        ))}
      </div>
